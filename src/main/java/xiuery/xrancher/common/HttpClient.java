...
public class HttpClient {
    ...
    private RequestEntity createRequestEntity( MultiValueMap<String, String> headers, HttpMethod method, String url) {
        return new RequestEntity<>(headers, method, createURI(url, null));
    }
     ...
     * @return RequestEntity
     */
    private RequestEntity createRequestEntity( MultiValueMap<String, String> body, MultiValueMap<String, String> headers,
                                               HttpMethod method, String url) {
        return new RequestEntity<>(body, headers, method, createURI(url, null));
    }
